Shader "DearImGui/Mesh"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/com.realgames.dear-imgui/Resources/Shaders/PassesUniversal.hlsl"
            ENDHLSL
        }
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma vertex ImGuiPassVertex
            #pragma fragment ImGuiPassFrag
            #include "Assets/com.realgames.dear-imgui/Resources/Shaders/PassesBuiltin.hlsl"
            ENDCG
        }
    }
}
